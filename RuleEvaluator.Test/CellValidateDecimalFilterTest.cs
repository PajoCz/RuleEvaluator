...
{
    [TestFixture]
    public class CellValidateDecimalFilterTest
    {
        ...
        {
            return new CellValidateDecimalFilter(-10m, false, 5m, false).Validate(p_Value);
        }
        ...
        {
            return new CellValidateDecimalFilter(-10m, true, 5m, false).Validate(p_Value);
        }
        ...
        {
            return new CellValidateDecimalFilter(-10m, false, 5m, true).Validate(p_Value);
        }
        ...
        {
            return new CellValidateDecimalFilter(-10m, true, 5m, true).Validate(p_Value);
        }
    }
}
